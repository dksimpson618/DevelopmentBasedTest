...
myvar01[2,2] == mytranspose(myvar01)[2,2] 
myvar01[3,1] == mytranspose(myvar01)[1,3]
myvar01[3,2] == mytranspose(myvar01)[2,3]
myvar01[4,1] == mytranspose(myvar01)[1,4] 
myvar01[4,2] == mytranspose(myvar01)[2,4]
myvar01[5,1] == mytranspose(myvar01)[1,5] 
...
myvar08[1,3] == mytranspose(myvar08)[3,1]
myvar08[2,1] == mytranspose(myvar08)[1,2]
myvar08[2,3] == mytranspose(myvar08)[3,2]
myvar08[3,1] == mytranspose(myvar08)[1,3]
myvar08[3,2] == mytranspose(myvar08)[2,3]
myvar08[4,1] == mytranspose(myvar08)[1,4]
myvar08[4,2] == mytranspose(myvar08)[2,4]
myvar08[4,3] == mytranspose(myvar08)[3,4]
